...
//     driveSetRaw(baseSpeed,baseSpeed-10);
//   }
//   else if (isBlack(ir.C)&&isBlack(ir.R)){
//     driveSetRaw(baseSpeed-10,baseSpeed);
//   }
//   else if(isBlack(ir.L)){
//     // 왼쪽이 라인 위 → 왼쪽으로 붙어있음 → 우측 더 빠르게
//     driveSetRaw(baseSpeed+45, 0);
//   }
//   else if(isBlack(ir.R)){
//     // 오른쪽이 라인 위 → 오른쪽으로 붙어있음 → 좌측 더 빠르게
//     driveSetRaw(0, baseSpeed+45);
//   }
//   else if (isWhite(ir.C)&&isWhite(ir.L)&&isWhite(ir.R)){
